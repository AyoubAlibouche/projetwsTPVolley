...
import tp.alibouche.projetws.beans.Etudiant;
...
public class EditActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String link = "android.resource://tp.alibouche.projetws/drawable/avatar";
    private int id = 0;
    RequestQueue requestQueue;
    String loadUrl = " http://192.168.198.2/projet1/ws/loadEtudiant.php";
    String updateUrl = " http://192.168.198.2/projet1/ws/updateEtudiant.php";
    @Override
            ...
            public void onResponse(String response) {
                ...
                for(Etudiant e : etudiants) {
                    if(e.getId() == id) {
                        ...
                        }else if(e.getVille().equals("Ouarzazate")) {
                        ...
                        if(e.getImg() == null) {
                            String link = "android.resource://tp.alibouche.projetws/drawable/avatar";
                            Glide
    ...
    public void onClick(View v) {
        ...
        if(v == remove) {
            link = "android.resource://tp.alibouche.projetws/drawable/avatar";
            bitmap = null;
            Glide
                    .with(getApplicationContext())
                    .load(Uri.parse(link))
